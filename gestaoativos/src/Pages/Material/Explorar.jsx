...
const Explorar = () => {
    ...
    const [armazensBD, setArmazensBD] = useState([]);
    ...
    // Lista fixa de armazéns para garantir que aparecem sempre 
    const listaArmazens = [
    ...
    const totalPaginas = Math.ceil(materiaisFiltrados.length / itensPorPagina); // Cálculo do total de páginas
        ...
        <div className="explorar-page">
            ...
            <footer className="footer-trabalho">
                <div className="footer-inner">
                    <span className="lang-text">PT | EN</span>
                    <button className="btn-explorar-footer">EXPLORAR MATERIAL</button>
                    <span className="status-text">
                        {eventoAtivo 
                            ? `ATUALMENTE A TRABALHAR EM: ${eventoAtivo.nome.toUpperCase()}` 
                            : "MODO DE CONSULTA (SELECIONE UM EVENTO NO PERFIL)"}
                    </span>
                </div>
            </footer>
        </div>
